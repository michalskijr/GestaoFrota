object DM: TDM
  ...
  object CAD_JURIDICA: TIBDataSet
    ...
    RefreshSQL.Strings = (
      ...
      '  CD_PESSOA = :CD_PESSOA')
    SelectSQL.Strings = (
      'select * from CAD_JURIDICA where CD_PESSOA = :PCDPESSOA')
    ModifySQL.Strings = (
      'update CAD_JURIDICA'
      'set'
      '  NR_CNPJ = :NR_CNPJ,'
  ...
  object CAD_CLIENTE: TIBDataSet
    ...
    RefreshSQL.Strings = (
      ...
      '  CD_PESSOA = :CD_PESSOA')
    SelectSQL.Strings = (
      'select * from CAD_CLIENTE where CD_PESSOA = :PCDPESSOA')
    ModifySQL.Strings = (
      'update CAD_CLIENTE'
      'set'
      '  DT_TRANSACAO = :DT_TRANSACAO'
  ...
  object CAD_MOTORISTA: TIBDataSet
    ...
    RefreshSQL.Strings = (
      ...
      '  CD_PESSOA = :CD_PESSOA')
    SelectSQL.Strings = (
      'select * from CAD_MOTORISTA where CD_PESSOA = :PCDPESSOA')
    ModifySQL.Strings = (
    ...
    Left = 232
    Top = 376
    object CAD_MOTORISTACD_MOTORISTA: TIntegerField
      FieldName = 'CD_MOTORISTA'
      Origin = 'CAD_MOTORISTA.CD_MOTORISTA'
      Required = True
    end
    object CAD_MOTORISTACD_PESSOA: TIntegerField
      FieldName = 'CD_PESSOA'
      Origin = 'CAD_MOTORISTA.CD_PESSOA'
      Required = True
    end
    object CAD_MOTORISTANR_CNH: TIBStringField
      FieldName = 'NR_CNH'
      Origin = 'CAD_MOTORISTA.NR_CNH'
      Required = True
    end
    object CAD_MOTORISTADS_CATEG_CNH: TIBStringField
      FieldName = 'DS_CATEG_CNH'
      Origin = 'CAD_MOTORISTA.DS_CATEG_CNH'
      FixedChar = True
      Size = 2
    end
    object CAD_MOTORISTADT_TRANSACAO: TDateField
      FieldName = 'DT_TRANSACAO'
      Origin = 'CAD_MOTORISTA.DT_TRANSACAO'
      Required = True
    end
  end
  ...
  object CAD_ENDERECO: TIBDataSet
    ...
    RefreshSQL.Strings = (
      ...
      '  NR_SEQ = :NR_SEQ')
    SelectSQL.Strings = (
      'select * from CAD_ENDERECO where CD_PESSOA = :PCDPESSOA')
    ModifySQL.Strings = (
      'update CAD_ENDERECO'
      'set'
  ...
  object IBQCAD_CONTATO: TIBQuery
    Database = Conection
    Transaction = Transaction
    Active = True
    BufferChunks = 1000
    ...
    object IBQCAD_CONTATONR_SEQ: TIntegerField
      FieldName = 'NR_SEQ'
      Origin = 'CAD_CONTATO.NR_SEQ'
      Required = True
    end
    object IBQCAD_CONTATOCD_PESSOA: TIntegerField
      FieldName = 'CD_PESSOA'
      Origin = 'CAD_CONTATO.CD_PESSOA'
      Required = True
    end
    object IBQCAD_CONTATONM_CONTATO: TIBStringField
      FieldName = 'NM_CONTATO'
      Origin = 'CAD_CONTATO.NM_CONTATO'
      Required = True
      Size = 60
    end
    object IBQCAD_CONTATONR_TELEFONE: TIBStringField
      FieldName = 'NR_TELEFONE'
      Origin = 'CAD_CONTATO.NR_TELEFONE'
      Size = 12
    end
    object IBQCAD_CONTATODS_EMAIL: TIBStringField
      FieldName = 'DS_EMAIL'
      Origin = 'CAD_CONTATO.DS_EMAIL'
      Size = 30
    end
  end
  object MOV_FRETE: TIBDataSet
    Database = Conection
    Transaction = Transaction
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from MOV_FRETE'
      'where'
      '  CD_FRETE = :OLD_CD_FRETE')
    InsertSQL.Strings = (
      'insert into MOV_FRETE'
      '  (CD_VEICULO, CD_MOTORISTA, CD_TIPO_CARGA, CD_CLIENTE, '
      'CD_CIDADE_ORIGEM, '
      '   DS_END_DESTINO, VL_FRETE, DT_TRANSACAO)'
      'values'
      '  (:CD_VEICULO, :CD_MOTORISTA, :CD_TIPO_CARGA, :CD_CLIENTE, '
      ':CD_CIDADE_ORIGEM, '
      '   :DS_END_DESTINO, :VL_FRETE, :DT_TRANSACAO)')
    RefreshSQL.Strings = (
      ...
      '  CD_FRETE = :CD_FRETE')
    SelectSQL.Strings = (
      'select * from MOV_FRETE where CD_FRETE = :PCDFRETE')
    ModifySQL.Strings = (
      'update MOV_FRETE'
      'set'
      '  CD_VEICULO = :CD_VEICULO,'
    ...
    Left = 568
    Top = 168
    object MOV_FRETECD_FRETE: TIntegerField
      FieldName = 'CD_FRETE'
      Origin = 'MOV_FRETE.CD_FRETE'
      Required = True
    end
    object MOV_FRETECD_VEICULO: TIntegerField
      FieldName = 'CD_VEICULO'
      Origin = 'MOV_FRETE.CD_VEICULO'
      Required = True
    end
    object MOV_FRETECD_MOTORISTA: TIntegerField
      FieldName = 'CD_MOTORISTA'
      Origin = 'MOV_FRETE.CD_MOTORISTA'
      Required = True
    end
    object MOV_FRETECD_TIPO_CARGA: TIntegerField
      FieldName = 'CD_TIPO_CARGA'
      Origin = 'MOV_FRETE.CD_TIPO_CARGA'
      Required = True
    end
    object MOV_FRETECD_CLIENTE: TIntegerField
      FieldName = 'CD_CLIENTE'
      Origin = 'MOV_FRETE.CD_CLIENTE'
      Required = True
    end
    object MOV_FRETECD_CIDADE_ORIGEM: TIntegerField
      FieldName = 'CD_CIDADE_ORIGEM'
      Origin = 'MOV_FRETE.CD_CIDADE_ORIGEM'
      Required = True
    end
    object MOV_FRETEDS_END_DESTINO: TIBStringField
      FieldName = 'DS_END_DESTINO'
      Origin = 'MOV_FRETE.DS_END_DESTINO'
      Size = 80
    end
    object MOV_FRETEVL_FRETE: TFloatField
      FieldName = 'VL_FRETE'
      Origin = 'MOV_FRETE.VL_FRETE'
    end
    object MOV_FRETEDT_TRANSACAO: TDateField
      FieldName = 'DT_TRANSACAO'
      Origin = 'MOV_FRETE.DT_TRANSACAO'
    end
  end
  object MOV_DESTINO_FRETE: TIBDataSet
    Database = Conection
    Transaction = Transaction
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from MOV_DESTINO_FRETE'
      'where'
      '  NR_SEQ = :OLD_NR_SEQ and'
      '  CD_FRETE = :OLD_CD_FRETE')
    InsertSQL.Strings = (
      'insert into MOV_DESTINO_FRETE'
      '  (CD_FRETE, CD_CIDADE, DS_LOGRADOURO, DS_NUMERO, DS_BAIRRO, '
      'DS_CEP, DS_OBSERVACAO, '
      '   DT_TRANSACAO)'
      'values'
    ...
    RefreshSQL.Strings = (
      ...
      '  DS_OBSERVACAO,'
      '  DT_TRANSACAO'
      'from MOV_DESTINO_FRETE '
      'where'
      '  NR_SEQ = :NR_SEQ and'
      '  CD_FRETE = :CD_FRETE')
    SelectSQL.Strings = (
      'select * from MOV_DESTINO_FRETE where CD_FRETE = :PCDFRETE')
    ModifySQL.Strings = (
      'update MOV_DESTINO_FRETE'
      'set'
      '  CD_CIDADE = :CD_CIDADE,'
      '  DS_LOGRADOURO = :DS_LOGRADOURO,'
      '  DS_NUMERO = :DS_NUMERO,'
    ...
    Left = 696
    Top = 168
    object MOV_DESTINO_FRETENR_SEQ: TIntegerField
      FieldName = 'NR_SEQ'
      Origin = 'MOV_DESTINO_FRETE.NR_SEQ'
      Required = True
    end
    object MOV_DESTINO_FRETECD_FRETE: TIntegerField
      FieldName = 'CD_FRETE'
      Origin = 'MOV_DESTINO_FRETE.CD_FRETE'
      Required = True
    end
    object MOV_DESTINO_FRETECD_CIDADE: TIntegerField
      FieldName = 'CD_CIDADE'
      Origin = 'MOV_DESTINO_FRETE.CD_CIDADE'
    end
    object MOV_DESTINO_FRETEDS_LOGRADOURO: TIBStringField
      FieldName = 'DS_LOGRADOURO'
      Origin = 'MOV_DESTINO_FRETE.DS_LOGRADOURO'
      Size = 100
    end
    object MOV_DESTINO_FRETEDS_NUMERO: TIBStringField
      FieldName = 'DS_NUMERO'
      Origin = 'MOV_DESTINO_FRETE.DS_NUMERO'
      Size = 30
    end
    object MOV_DESTINO_FRETEDS_BAIRRO: TIBStringField
      FieldName = 'DS_BAIRRO'
      Origin = 'MOV_DESTINO_FRETE.DS_BAIRRO'
      Size = 60
    end
    object MOV_DESTINO_FRETEDS_CEP: TIBStringField
      FieldName = 'DS_CEP'
      Origin = 'MOV_DESTINO_FRETE.DS_CEP'
      Size = 8
    end
    object MOV_DESTINO_FRETEDS_OBSERVACAO: TIBStringField
      FieldName = 'DS_OBSERVACAO'
      Origin = 'MOV_DESTINO_FRETE.DS_OBSERVACAO'
      Size = 500
    end
    object MOV_DESTINO_FRETEDT_TRANSACAO: TDateField
      FieldName = 'DT_TRANSACAO'
      Origin = 'MOV_DESTINO_FRETE.DT_TRANSACAO'
    end
  end
  object IBQMOV_DESTINO_FRETE: TIBQuery
    Database = Conection
    Transaction = Transaction
    Active = True
    BufferChunks = 1000
    ...
    object IBQMOV_DESTINO_FRETENR_SEQ: TIntegerField
      FieldName = 'NR_SEQ'
      Origin = 'MOV_DESTINO_FRETE.NR_SEQ'
      Required = True
    end
    object IBQMOV_DESTINO_FRETECD_FRETE: TIntegerField
      FieldName = 'CD_FRETE'
      Origin = 'MOV_DESTINO_FRETE.CD_FRETE'
      Required = True
    end
    object IBQMOV_DESTINO_FRETECD_CIDADE: TIntegerField
      FieldName = 'CD_CIDADE'
      Origin = 'MOV_DESTINO_FRETE.CD_CIDADE'
    end
    object IBQMOV_DESTINO_FRETENM_CIDADE: TIBStringField
      FieldName = 'NM_CIDADE'
      Origin = 'CAD_CIDADE.NM_CIDADE'
      Size = 50
    end
    object IBQMOV_DESTINO_FRETEDS_LOGRADOURO: TIBStringField
      FieldName = 'DS_LOGRADOURO'
      Origin = 'MOV_DESTINO_FRETE.DS_LOGRADOURO'
      Size = 100
    end
    object IBQMOV_DESTINO_FRETEDS_NUMERO: TIBStringField
      FieldName = 'DS_NUMERO'
      Origin = 'MOV_DESTINO_FRETE.DS_NUMERO'
      Size = 30
    end
    object IBQMOV_DESTINO_FRETEDS_BAIRRO: TIBStringField
      FieldName = 'DS_BAIRRO'
      Origin = 'MOV_DESTINO_FRETE.DS_BAIRRO'
      Size = 60
    end
    object IBQMOV_DESTINO_FRETEDS_CEP: TIBStringField
      FieldName = 'DS_CEP'
      Origin = 'MOV_DESTINO_FRETE.DS_CEP'
      Size = 8
    end
    object IBQMOV_DESTINO_FRETEDS_OBSERVACAO: TIBStringField
      FieldName = 'DS_OBSERVACAO'
      Origin = 'MOV_DESTINO_FRETE.DS_OBSERVACAO'
      Size = 500
    end
    object IBQMOV_DESTINO_FRETEDT_TRANSACAO: TDateField
      FieldName = 'DT_TRANSACAO'
      Origin = 'MOV_DESTINO_FRETE.DT_TRANSACAO'
    end
  end
  object IBQCAD_CLIENTE: TIBQuery
    Database = Conection
    Transaction = Transaction
    Active = True
    BufferChunks = 1000
    ...
    SQL.Strings = (
        ...
        'select CLIENTE.CD_CLIENTE, PESSOA.NM_RZ_SOCIAL, CLIENTE.CD_PESSO' +
        'A, CLIENTE.DT_TRANSACAO  '
      'from CAD_CLIENTE CLIENTE'
      
        'INNER JOIN CAD_PESSOA PESSOA ON (PESSOA.CD_PESSOA = CLIENTE.CD_P' +
        'ESSOA)')
    Left = 464
    Top = 312
    object IBQCAD_CLIENTECD_CLIENTE: TIntegerField
      FieldName = 'CD_CLIENTE'
      Origin = 'CAD_CLIENTE.CD_CLIENTE'
      Required = True
    end
    object IBQCAD_CLIENTECD_PESSOA: TIntegerField
      FieldName = 'CD_PESSOA'
      Origin = 'CAD_CLIENTE.CD_PESSOA'
      Required = True
    end
    object IBQCAD_CLIENTEDT_TRANSACAO: TDateField
      FieldName = 'DT_TRANSACAO'
      Origin = 'CAD_CLIENTE.DT_TRANSACAO'
      Required = True
    end
    object IBQCAD_CLIENTENM_RZ_SOCIAL: TIBStringField
      FieldName = 'NM_RZ_SOCIAL'
      Origin = 'CAD_PESSOA.NM_RZ_SOCIAL'
      Required = True
      Size = 100
  ...
  object IBQCAD_MOTORISTA: TIBQuery
    Database = Conection
    Transaction = Transaction
    Active = True
    BufferChunks = 1000
    ...
    SQL.Strings = (
        ...
        'select MOTORISTA.CD_MOTORISTA, PESSOA.NM_RZ_SOCIAL, MOTORISTA.CD' +
        '_PESSOA  '
      'from CAD_MOTORISTA MOTORISTA'
      
        'INNER JOIN CAD_PESSOA PESSOA ON (PESSOA.CD_PESSOA = MOTORISTA.CD' +
        '_PESSOA)')
    Left = 464
    Top = 376
    object IBQCAD_MOTORISTACD_MOTORISTA: TIntegerField
      FieldName = 'CD_MOTORISTA'
      Origin = 'CAD_MOTORISTA.CD_MOTORISTA'
      Required = True
    end
    object IBQCAD_MOTORISTANM_RZ_SOCIAL: TIBStringField
      FieldName = 'NM_RZ_SOCIAL'
      Origin = 'CAD_PESSOA.NM_RZ_SOCIAL'
      Required = True
      Size = 100
    end
    object IBQCAD_MOTORISTACD_PESSOA: TIntegerField
      FieldName = 'CD_PESSOA'
      Origin = 'CAD_MOTORISTA.CD_PESSOA'
      Required = True
    end
